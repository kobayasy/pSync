<!--
NOTE_ja.md - Last modified: 29-Nov-2025 (kobayasy)
-->

[使い方のヒント](#使い方のヒント) [ [日本語マニュアル](#日本語マニュアル) | [パスワード入力の自動化](#パスワード入力の自動化) | [ファイル更新があった時に psync を自動実行](#ファイル更新があった時に-psync-を自動実行) ] / [README](../README_ja.md)

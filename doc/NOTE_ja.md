<!--
NOTE_ja.md - Last modified: 13-Jan-2026 (kobayasy)
-->

[使い方のヒント](#使い方のヒント) [ [日本語マニュアル](#日本語マニュアル) | [pSync を作った理由](#pSync-を作った理由) | [パスワード入力の自動化](#パスワード入力の自動化) | [ファイル更新があった時に psync を自動実行](#ファイル更新があった時に-psync-を自動実行) ] / [README](../README_ja.md)
...
しかし、二度と同じ思いはしたくありません。^[この一件以来、バックアップは二重に取るようになり、同様のミスは起こしていません。結果として、良い教訓を得られた経験だったと言えるかもしれません。]

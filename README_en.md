<!--
README_en.md - Last modified: 14-Feb-2026 (kobayasy)
-->
...
```sh
curl -LOJs https://github.com/kobayasy/pSync/releases/download/3.11/psync-3.11.tar.gz
tar xzf psync-3.11.tar.gz
cd psync-3.11

<!--
README_en.md - Last modified: 07-Mar-2026 (kobayasy)
-->
...
```sh
curl -LOJs https://github.com/kobayasy/pSync/releases/download/3.17/psync-3.17.tar.gz
tar xzf psync-3.17.tar.gz
cd psync-3.17
